...
void updatePidMotorOutputs(int channel, Direction* direction, int* percentageOutput)
{
	...
	integratedAngleErrors[channel] = (angleErrors[channel] < I_GAIN_THRESHHOLD_ERROR ? integratedAngleErrors[channel] + directionSign * angleErrors[channel] * pidLoopInterval / 1000.0 : 0);
